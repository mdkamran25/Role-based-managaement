            ...
            <div className='d-flex justify-content-center align-items-center'>
                <div className='container bg-light py-5 rounded-4 Trainee-Profile-container'>
                    <div className="row g-0 d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-evenly">
                        ...
                        <div className='col-10 col-md-8 Personal-Detail rounded-4 py-5'>
                        ...
                        <div className=' col-10 col-md-3  Social-Media rounded-4 py-5 mt-3'>
                            <div className='col-12 d-flex px-3'>
                                ...
                                <a className='nav-link active ms-auto' href="#">https://www.linkdin.com</a>
                            </div>
                            <hr />
                            <div className='col-12 d-flex px-3'>
                                <img src={githubIcon} width={30} />
                                <a className='nav-link active ms-auto' href="#">https://www.github.com</a>
                            </div>
                            
                        </div>
                        <div className='col-10 col-md-4 Course-Completed rounded-4 py-5 mt-3'>
                            <p className='fw-bold fs-5 px-3'>Topics To Learn</p>
                            <div className='col-12 d-flex px-3'>
                                <img src={linkdinIcon} width={30} />
                                <a className='nav-link active ms-auto' href="#">https://www.linkdin.com</a>
                            </div>
                            <hr /><div className='col-12 d-flex px-3'>
                                <img src={linkdinIcon} width={30} />
                                <a className='nav-link active ms-auto' href="#">https://www.linkdin.com</a>
                            </div>
                            <hr /><div className='col-12 d-flex px-3'>
                        ...
                        <div className='col-10 col-md-4 Task-Completed rounded-4 py-5 mt-3'>
                            Task Completed
                        </div>
                    </div>
                </div>
